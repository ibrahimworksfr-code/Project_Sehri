...
| `high_value_night_intent` | Boolean | Gold | The master target variable for supervised propensity modeling (Logistic Regression). Identifies cohorts highly likely to purchase premium bundles during the Sehri graveyard shift. | Engineered target. Strictly binarized for classification. |
